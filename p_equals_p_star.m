...
OMG = zeros(length(alpha),length(beta));
SGM = zeros(length(alpha),length(beta));
AA = zeros(length(alpha),length(beta));
...
title({'α=1，β=1对应的信号的实部'; ['此时θ=[', num2str(THETA(201, 201, 1)),'; ' ...
    , num2str(THETA(201, 201, 2)), '; ', num2str(THETA(201, 201, 3)), ';', ...
    num2str(THETA(201, 201, 4)), '; ', num2str(THETA(201, 201, 5)), ';', num2str(THETA(201, 201, 6)), ']']})
grid on
...
title({'α=1，β=-1对应的信号的实部'; ['此时θ=[', num2str(THETA(201, 1, 1)),'; ' ...
    , num2str(THETA(201, 1, 2)), '; ', num2str(THETA(201, 1, 3)), ';', ...
    num2str(THETA(201, 1, 4)), '; ', num2str(THETA(201, 1, 5)), ';', num2str(THETA(201, 1, 6)), ']']})
grid on
...
title({'α=-1，β=-1对应的信号的实部'; ['此时θ=[', num2str(THETA(1, 1, 1)),'; ' ...
    , num2str(THETA(1, 1, 2)), '; ', num2str(THETA(1, 1, 3)), ';', ...
    num2str(THETA(1, 1, 4)), '; ', num2str(THETA(1, 1, 5)), ';', num2str(THETA(1, 1, 6)), ']']})
grid on
...
title({'α=-1，β=1对应的信号的实部'; ['此时θ=[', num2str(THETA(1, 201, 1)),'; ' ...
    , num2str(THETA(1, 201, 2)), '; ', num2str(THETA(1, 201, 3)), ';', ...
    num2str(THETA(1, 201, 4)), '; ', num2str(THETA(1, 201, 5)), ';', num2str(THETA(1, 201, 6)), ']']})
grid on
